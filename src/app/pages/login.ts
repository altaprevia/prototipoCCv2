          ...
          <div class="w-full max-w-sm">
            <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
              ...
              <form (ngSubmit)="onLogin()" class="space-y-5">
                ...
                <button
                  type="submit"
                  class="w-full bg-cyan-500 hover:bg-cyan-600 text-white font-mulish font-semibold py-3 rounded-lg transition-all duration-300 ease-out transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
                >
                  {{ loginBtn }} →
                </button>
              </form>
